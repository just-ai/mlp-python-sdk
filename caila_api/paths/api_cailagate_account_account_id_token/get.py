...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AccessTokenData']:
            return AccessTokenData

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['AccessTokenData'], typing.List['AccessTokenData']],
    ...
    def __getitem__(self, i: int) -> 'AccessTokenData':
...
class ListAccessTokens(BaseApi):
    ...
    def list_access_tokens(
        ...
        return self._list_access_tokens_oapg(
