...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['FitConfigData']:
            return FitConfigData

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['FitConfigData'], typing.List['FitConfigData']],
    ...
    def __getitem__(self, i: int) -> 'FitConfigData':
...
class ListFitConfigs(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_fit_configs(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_fit_configs(
        ...
        return self._list_fit_configs_oapg(
