...
# body param
SchemaForRequestBodyApplicationJson = ModelCreateUpdateData


request_body_model_create_update_data = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_model_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_model_create_update_data.serialize(body, content_type)
...
class UpdateModel(BaseApi):
    ...
    def update_model(
        ...
        return self._update_model_oapg(
            body=body,
