...
# body param
SchemaForRequestBodyApplicationJson = FitRequestData


request_body_fit_request_data = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _fit_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_fit_request_data.serialize(body, content_type)
