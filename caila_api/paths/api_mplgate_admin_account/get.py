...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AccountInfoData']:
            return AccountInfoData

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['AccountInfoData'], typing.List['AccountInfoData']],
    ...
    def __getitem__(self, i: int) -> 'AccountInfoData':
