...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ModelInstance']:
            return ModelInstance

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ModelInstance'], typing.List['ModelInstance']],
    ...
    def __getitem__(self, i: int) -> 'ModelInstance':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_account_instances_with_deleted_oapg(
        self,
...
class GetAccountInstancesWithDeleted(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_account_instances_with_deleted(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_account_instances_with_deleted(
        ...
        return self._get_account_instances_with_deleted_oapg(
