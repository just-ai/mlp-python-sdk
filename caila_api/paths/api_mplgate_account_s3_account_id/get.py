...
SchemaFor200ResponseBodyApplicationJson = S3CredentialsData
...
class GetS3Credentials(BaseApi):
    ...
    def get_s3_credentials(
        ...
        return self._get_s3_credentials_oapg(
