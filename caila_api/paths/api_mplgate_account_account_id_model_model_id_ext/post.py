...
# body param
SchemaForRequestBodyApplicationJson = ExtendedRequestData


request_body_extended_request_data = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _ext_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_extended_request_data.serialize(body, content_type)
