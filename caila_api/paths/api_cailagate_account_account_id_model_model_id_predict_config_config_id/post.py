...
ConfigIdSchema = schemas.Int64Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'configId': typing.Union[ConfigIdSchema, decimal.Decimal, int, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = ConfigCreateUpdateData


request_body_config_create_update_data = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PredictConfigData
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_predict_config_oapg(
        self,
    ...
    def _update_predict_config_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_config_create_update_data.serialize(body, content_type)
...
class UpdatePredictConfig(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_predict_config(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def update_predict_config(
        ...
        return self._update_predict_config_oapg(
            body=body,
