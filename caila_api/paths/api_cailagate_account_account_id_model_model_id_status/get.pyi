...
SchemaFor200ResponseBodyApplicationJson = ModelShortStatusData
...
class ShortModelStatus(BaseApi):
    ...
    def short_model_status(
        ...
        return self._short_model_status_oapg(
