...
SchemaFor200ResponseBodyApplicationJson = InstancesStatusData
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_instances_status_oapg(
        self,
...
class GetInstancesStatus(BaseApi):
    ...
    def get_instances_status(
        ...
        return self._get_instances_status_oapg(
