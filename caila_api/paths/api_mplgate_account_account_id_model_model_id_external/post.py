...
SchemaFor200ResponseBodyApplicationJson = ExternalConnectionInfoData
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_external_connection_oapg(
        self,
...
class CreateExternalConnection(BaseApi):
    ...
    def create_external_connection(
        ...
        return self._create_external_connection_oapg(
