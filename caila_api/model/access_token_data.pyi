...
class AccessTokenData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["token", "name", "creationDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["token", "name", "creationDate", ], str]):
