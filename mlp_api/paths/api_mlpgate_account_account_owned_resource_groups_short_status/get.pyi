...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ResourceGroupShortStatusData']:
            return ResourceGroupShortStatusData

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ResourceGroupShortStatusData'], typing.List['ResourceGroupShortStatusData']],
    ...
    def __getitem__(self, i: int) -> 'ResourceGroupShortStatusData':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_owned_resource_groups_short_status_oapg(
        self,
...
class GetOwnedResourceGroupsShortStatus(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_owned_resource_groups_short_status(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_owned_resource_groups_short_status(
        ...
        return self._get_owned_resource_groups_short_status_oapg(
