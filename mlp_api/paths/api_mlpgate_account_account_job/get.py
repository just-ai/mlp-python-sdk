...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['JobStatusData']:
            return JobStatusData

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['JobStatusData'], typing.List['JobStatusData']],
    ...
    def __getitem__(self, i: int) -> 'JobStatusData':
