...
# body param
SchemaForRequestBodyApplicationJson = ImageInfoData


request_body_image_info_data = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ImageInfoData
...
class BaseApi(api_client.Api):
    ...
    def _update_image_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_image_info_data.serialize(body, content_type)
