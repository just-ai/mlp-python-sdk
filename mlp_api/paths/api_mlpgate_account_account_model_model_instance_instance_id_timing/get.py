...
SchemaFor200ResponseBodyApplicationJson = ModelStartTimeData
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_model_instance_start_time_oapg(
        self,
...
class GetModelInstanceStartTime(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_model_instance_start_time(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_model_instance_start_time(
        ...
        return self._get_model_instance_start_time_oapg(
