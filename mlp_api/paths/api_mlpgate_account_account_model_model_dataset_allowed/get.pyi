...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['DatasetInfoData']:
            return DatasetInfoData

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['DatasetInfoData'], typing.List['DatasetInfoData']],
    ...
    def __getitem__(self, i: int) -> 'DatasetInfoData':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_allowed_datasets_for_fit_oapg(
        self,
...
class GetAllowedDatasetsForFit(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_allowed_datasets_for_fit(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_allowed_datasets_for_fit(
        ...
        return self._get_allowed_datasets_for_fit_oapg(
