...
AliasIdSchema = schemas.Int64Schema
ModelSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'account': typing.Union[AccountSchema, str, ],
        'aliasId': typing.Union[AliasIdSchema, decimal.Decimal, int, ],
...
request_path_alias_id = api_client.PathParameter(
    name="aliasId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AliasIdSchema,
    required=True,
)
...
class DeleteAlias(BaseApi):
    ...
    def delete_alias(
        ...
        return self._delete_alias_oapg(
