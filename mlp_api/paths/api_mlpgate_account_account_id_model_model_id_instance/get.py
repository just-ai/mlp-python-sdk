...
SchemaFor200ResponseBodyApplicationJson = ModelInstanceListData
...
class GetModelInstances(BaseApi):
    ...
    def get_model_instances(
        ...
        return self._get_model_instances_oapg(
