        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    ...
                    "INSTANCE_CPU_REQUESTED": "CPU_REQUESTED",
                    "INSTANCE_CPU_LIMIT": "CPU_LIMIT",
                    "INSTANCE_RAM_USAGE": "RAM_USAGE",
                    "INSTANCE_RAM_REQUESTED": "RAM_REQUESTED",
                    "INSTANCE_RAM_LIMIT": "RAM_LIMIT",
                    "INSTANCE_RECONNECTS_COUNT": "RECONNECTS_COUNT",
                }
            
            @schemas.classproperty
            def CPU_USAGE(cls):
                return cls("INSTANCE_CPU_USAGE")
            
            @schemas.classproperty
            def CPU_REQUESTED(cls):
                return cls("INSTANCE_CPU_REQUESTED")
            
            @schemas.classproperty
            def CPU_LIMIT(cls):
                return cls("INSTANCE_CPU_LIMIT")
            
            @schemas.classproperty
            def RAM_USAGE(cls):
                return cls("INSTANCE_RAM_USAGE")
            
            @schemas.classproperty
            def RAM_REQUESTED(cls):
                return cls("INSTANCE_RAM_REQUESTED")
            
            @schemas.classproperty
            def RAM_LIMIT(cls):
                return cls("INSTANCE_RAM_LIMIT")
            
            @schemas.classproperty
            def RECONNECTS_COUNT(cls):
                return cls("INSTANCE_RECONNECTS_COUNT")
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_instance_metric_range_oapg(
        self,
...
class GetInstanceMetricRange(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_instance_metric_range(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def get_instance_metric_range(
        ...
        return self._get_instance_metric_range_oapg(
