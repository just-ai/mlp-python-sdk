...
SchemaFor200ResponseBodyApplicationJson = HealthCheckHistoryResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _health_check_history_oapg(
        self,
...
class HealthCheckHistory(BaseApi):
    ...
    def health_check_history(
        ...
        return self._health_check_history_oapg(
