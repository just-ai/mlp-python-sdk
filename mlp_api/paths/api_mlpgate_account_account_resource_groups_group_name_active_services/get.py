...
SchemaFor200ResponseBodyApplicationJson = ResourceGroupServicesData
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_resource_group_active_services_oapg(
        self,
...
class GetResourceGroupActiveServices(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_resource_group_active_services(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_resource_group_active_services(
        ...
        return self._get_resource_group_active_services_oapg(
