...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PredictConfigData']:
            return PredictConfigData

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['PredictConfigData'], typing.List['PredictConfigData']],
    ...
    def __getitem__(self, i: int) -> 'PredictConfigData':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_predict_configs_oapg(
        self,
...
class ListPredictConfigs(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_predict_configs(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_predict_configs(
        ...
        return self._list_predict_configs_oapg(
