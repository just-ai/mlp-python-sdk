...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_earliest_timestamp_of_instance_metric_oapg(
        self,
...
class GetEarliestTimestampOfInstanceMetric(BaseApi):
    ...
    def get_earliest_timestamp_of_instance_metric(
        ...
        return self._get_earliest_timestamp_of_instance_metric_oapg(
