...
# body param
SchemaForRequestBodyApplicationJson = AccountLimitsData


request_body_account_limits_data = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_limits_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_account_limits_data.serialize(body, content_type)
...
class UpdateLimits(BaseApi):
    ...
    def update_limits(
        ...
        return self._update_limits_oapg(
            body=body,
