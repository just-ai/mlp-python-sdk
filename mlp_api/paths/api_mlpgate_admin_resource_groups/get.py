...
SchemaFor200ResponseBodyApplicationJson = ResourceGroupsData
...
class GetResourceGroups(BaseApi):
    ...
    def get_resource_groups(
        ...
        return self._get_resource_groups_oapg(
