...
SchemaFor200ResponseBodyApplicationJson = ResponseBodyEmitter
...
class BaseApi(api_client.Api):
    @typing.overload
    def _predict_with_config_v2_stream_oapg(
        self,
...
class PredictWithConfigV2Stream(BaseApi):
    ...
    def predict_with_config_v2_stream(
        ...
        return self._predict_with_config_v2_stream_oapg(
            body=body,
