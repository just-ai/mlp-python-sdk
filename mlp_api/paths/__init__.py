...
class PathValues(str, enum.Enum):
    ...
    API_MLPGATE_ACCOUNT_ACCOUNT_RESOURCEGROUPS_GROUP_NAME_QUOTA = "/api/mlpgate/account/{account}/resource-groups/{groupName}/quota"
    ...
    API_MLPGATE_ACCOUNT_ACCOUNT_MODEL_MODEL_PREDICTWITHCONFIGV2STREAM = "/api/mlpgate/account/{account}/model/{model}/predict-with-config-v2-stream"
    ...
    API_MLPGATE_ACCOUNT_ACCOUNT_MODEL_MODEL_HTTP = "/api/mlpgate/account/{account}/model/{model}/http"
    ...
    API_MLPGATE_ACCOUNT_ACCOUNT_MODEL_MODEL_ARCHIVE = "/api/mlpgate/account/{account}/model/{model}/archive"
    API_MLPGATE_ACCOUNT_ACCOUNT_MODEL_MODEL_ALIAS = "/api/mlpgate/account/{account}/model/{model}/alias"
    ...
    API_MLPGATEINTERNAL_ACCOUNT_ACCOUNT_RESOURCEGROUPS_TEST = "/api/mlpgate-internal/account/{account}/resource-groups/test"
    ...
    API_MLPGATE_SPECS_APIFILE = "/api/mlpgate/specs/{api-file}"
    ...
    API_MLPGATE_ACCOUNT_ACCOUNT_RESOURCEGROUPS_GROUP_NAME_SERVICESINFO = "/api/mlpgate/account/{account}/resource-groups/{groupName}/services-info"
    ...
    API_MLPGATE_ACCOUNT_ACCOUNT_MODELS_METRICS = "/api/mlpgate/account/{account}/models/metrics"
    ...
    API_MLPGATE_ACCOUNT_ACCOUNT_RESOURCEGROUPS_GROUP_NAME_QUOTA_QUOTA_ID = "/api/mlpgate/account/{account}/resource-groups/{groupName}/quota/{quotaId}"
    ...
    API_MLPGATE_ACCOUNT_ACCOUNT_MODEL_MODEL_ALIAS_ALIAS_ID = "/api/mlpgate/account/{account}/model/{model}/alias/{aliasId}"
    ...
    API_MLPGATEINTERNAL_ACCOUNT_ACCOUNT_RESOURCEGROUPS_GROUP_NAME_SERVER_SERVER_ID = "/api/mlpgate-internal/account/{account}/resource-groups/{groupName}/server/{serverId}"
