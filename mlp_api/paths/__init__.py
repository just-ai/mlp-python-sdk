...
class PathValues(str, enum.Enum):
    ...
    API_MLPGATE_ACCOUNT_ACCOUNT_RESOURCEGROUP = "/api/mlpgate/account/{account}/resource-group"
    ...
    API_MLPGATE_ACCOUNT_ACCOUNT_RESOURCEGROUPS_GROUP_NAME_SERVERS = "/api/mlpgate/account/{account}/resource-groups/{groupName}/servers"
    API_MLPGATE_ACCOUNT_ACCOUNT_RESOURCEGROUPS_GROUP_NAME_SERVERS_STATUS = "/api/mlpgate/account/{account}/resource-groups/{groupName}/servers/status"
