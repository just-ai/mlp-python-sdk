...
class PathValues(str, enum.Enum):
    ...
    API_MLPGATE_ACCOUNT_ACCOUNT_ID_MODEL_MODEL_ID_MODELGROUP_GROUP_ID = "/api/mlpgate/account/{accountId}/model/{modelId}/model-group/{groupId}"
    ...
    API_MLPGATE_MODEL = "/api/mlpgate/model"
    API_MLPGATE_MODEL_FEATURED = "/api/mlpgate/model/featured"
    ...
    API_MLPGATE_ACCOUNT_ACCOUNT_ID_MODELGROUP_GROUP_ID = "/api/mlpgate/account/{accountId}/model-group/{groupId}"
