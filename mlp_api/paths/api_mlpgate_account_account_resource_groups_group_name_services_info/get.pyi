...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ServiceInfoAtTime']:
            return ServiceInfoAtTime

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ServiceInfoAtTime'], typing.List['ServiceInfoAtTime']],
    ...
    def __getitem__(self, i: int) -> 'ServiceInfoAtTime':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_resource_group_services_info_oapg(
        self,
...
class GetResourceGroupServicesInfo(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_resource_group_services_info(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def get_resource_group_services_info(
        ...
        return self._get_resource_group_services_info_oapg(
