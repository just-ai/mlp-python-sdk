...
# body param
SchemaForRequestBodyApplicationJson = ModelPublicSettingsData


request_body_model_public_settings_data = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ModelPublicSettingsData
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_model_public_settings_oapg(
        self,
    ...
    def _update_model_public_settings_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_model_public_settings_data.serialize(body, content_type)
...
class UpdateModelPublicSettings(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_model_public_settings(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def update_model_public_settings(
        ...
        return self._update_model_public_settings_oapg(
            body=body,
