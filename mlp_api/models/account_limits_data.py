...
class AccountLimitsData(BaseModel):
    ...
    AccountLimitsData
    """
    base_model_instance_limit: StrictInt = Field(..., alias="baseModelInstanceLimit")
    derived_model_instance_limit: StrictInt = Field(..., alias="derivedModelInstanceLimit")
    gpu_model_instance_limit: StrictInt = Field(..., alias="gpuModelInstanceLimit")
    cpu_limit: StrictStr = Field(..., alias="cpuLimit")
    memory_limit: StrictStr = Field(..., alias="memoryLimit")
    ephemeral_disk_limit: StrictStr = Field(..., alias="ephemeralDiskLimit")
    predict_per_sec: StrictInt = Field(..., alias="predictPerSec")
    fit_per_minute: StrictInt = Field(..., alias="fitPerMinute")
