...
class AccountInfoData(BaseModel):
    ...
    limits: AccountLimitsData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountInfoData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountInfoData:
        """Create an instance of AccountInfoData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountInfoData.parse_obj(obj)

        _obj = AccountInfoData.parse_obj({
            "account_id": obj.get("accountId"),
            "short_name": obj.get("shortName"),
            "limits": AccountLimitsData.from_dict(obj.get("limits")) if obj.get("limits") is not None else None,
