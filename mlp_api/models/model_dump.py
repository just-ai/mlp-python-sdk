...
class ModelDump(BaseModel):
    ...
    show_personal_data_disclaimer: StrictBool = Field(default=..., alias="showPersonalDataDisclaimer")
    deployment_patch: Optional[Dict[str, Any]] = Field(default=None, alias="deploymentPatch")
    proxy_target_account: Optional[StrictStr] = Field(default=None, alias="proxyTargetAccount")
    proxy_target_model_name: Optional[StrictStr] = Field(default=None, alias="proxyTargetModelName")
    ...
    def billing_unit_validate_enum(cls, value):
        ...
        if value not in ('calls', 'direct', 'custom', 'cost'):
            raise ValueError("must be one of enum values ('calls', 'direct', 'custom', 'cost')")
        return value
    ...
    def from_dict(cls, obj: dict) -> ModelDump:
        ...
        _obj = ModelDump.parse_obj({
            ...
            "proxy_target_account": obj.get("proxyTargetAccount"),
            "proxy_target_model_name": obj.get("proxyTargetModelName"),
