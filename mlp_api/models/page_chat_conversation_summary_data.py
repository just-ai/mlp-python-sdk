...
class PageChatConversationSummaryData(BaseModel):
    """
    PageChatConversationSummaryData
    """
    ...
    content: Optional[conlist(ChatConversationSummaryData)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageChatConversationSummaryData:
        """Create an instance of PageChatConversationSummaryData from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageChatConversationSummaryData:
        """Create an instance of PageChatConversationSummaryData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageChatConversationSummaryData.parse_obj(obj)

        _obj = PageChatConversationSummaryData.parse_obj({
            ...
            "size": obj.get("size"),
            "content": [ChatConversationSummaryData.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
