...
class UpdateResourceGroupData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateResourceGroupData:
        """Create an instance of UpdateResourceGroupData from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateResourceGroupData:
        """Create an instance of UpdateResourceGroupData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateResourceGroupData.parse_obj(obj)

        _obj = UpdateResourceGroupData.parse_obj({
            "name": obj.get("name"),
