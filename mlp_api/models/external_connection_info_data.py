...
class ExternalConnectionInfoData(BaseModel):
    ...
    docker_run_command: StrictStr = Field(..., alias="dockerRunCommand")
    env_variables: Dict[str, StrictStr] = Field(..., alias="envVariables")
    __properties = ["id", "connected", "dockerRunCommand", "envVariables"]
