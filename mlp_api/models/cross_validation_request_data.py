...
class CrossValidationRequestData(BaseModel):
    ...
    """
    base_model_account_id: Optional[StrictInt] = Field(None, alias="baseModelAccountId")
    base_model_id: Optional[StrictInt] = Field(None, alias="baseModelId")
    target_model_account_id: Optional[StrictInt] = Field(None, alias="targetModelAccountId")
    target_model_name: Optional[StrictStr] = Field(None, alias="targetModelName")
    fit_config: Optional[Dict[str, Any]] = Field(None, alias="fitConfig")
    fit_config_id: Optional[StrictInt] = Field(None, alias="fitConfigId")
    dataset_id: StrictInt = Field(..., alias="datasetId")
    predict_config: Optional[Dict[str, Any]] = Field(None, alias="predictConfig")
    predict_config_id: Optional[StrictInt] = Field(None, alias="predictConfigId")
    parts: StrictInt = Field(...)
    min_intent_size_to_divide: StrictInt = Field(..., alias="minIntentSizeToDivide")
