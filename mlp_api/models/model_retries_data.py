...
class ModelRetriesData(BaseModel):
    ...
    ModelRetriesData
    """
    max_retries: StrictInt = Field(default=..., alias="maxRetries")
    timeouts_ms: conlist(StrictInt) = Field(default=..., alias="timeoutsMs")
    max_retries_per_instance: Optional[StrictInt] = Field(default=None, alias="maxRetriesPerInstance")
