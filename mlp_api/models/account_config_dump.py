...
class AccountConfigDump(BaseModel):
    ...
    account_limits: Optional[AccountLimitsData] = Field(default=None, alias="accountLimits")
    language: Optional[StrictStr] = None
    tags: Optional[Dict[str, StrictStr]] = None
    account_display_name: Optional[StrictStr] = Field(default=None, alias="accountDisplayName")
