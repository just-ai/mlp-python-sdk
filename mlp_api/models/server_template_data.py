...
class ServerTemplateData(BaseModel):
    ...
    __properties = ["id", "name", "type", "capacity", "description", "rawConfiguration", "tarifficationPrice", "tarifficationPeriod"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerTemplateData:
        """Create an instance of ServerTemplateData from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerTemplateData:
        """Create an instance of ServerTemplateData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerTemplateData.parse_obj(obj)

        _obj = ServerTemplateData.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type"),
