...
class UINotificationData(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('NO_ONE_VAST_AI_OFFER', 'VAST_AI_SERVER_CANNOT_START_INSTANCE', 'SERVER_EVENTS_ERROR_INDICATOR', 'MODEL_EVENTS_ERROR_INDICATOR', 'TOKEN_EXPIRATION_WARNING', 'PIPELINE_OPERATION', 'BROADCAST', 'LICENSE_EXPIRES_SOON', 'LICENSE_NOT_VALID', 'LICENSE_LIMITS_EXCEEDED', 'NONE'):
            raise ValueError("must be one of enum values ('NO_ONE_VAST_AI_OFFER', 'VAST_AI_SERVER_CANNOT_START_INSTANCE', 'SERVER_EVENTS_ERROR_INDICATOR', 'MODEL_EVENTS_ERROR_INDICATOR', 'TOKEN_EXPIRATION_WARNING', 'PIPELINE_OPERATION', 'BROADCAST', 'LICENSE_EXPIRES_SOON', 'LICENSE_NOT_VALID', 'LICENSE_LIMITS_EXCEEDED', 'NONE')")
        return value
