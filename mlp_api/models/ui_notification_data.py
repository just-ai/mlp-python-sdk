...
class UINotificationData(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('SERVER_EVENTS_ERROR_INDICATOR', 'MODEL_EVENTS_ERROR_INDICATOR', 'PIPELINE_OPERATION', 'BROADCAST', 'NONE'):
            raise ValueError("must be one of enum values ('SERVER_EVENTS_ERROR_INDICATOR', 'MODEL_EVENTS_ERROR_INDICATOR', 'PIPELINE_OPERATION', 'BROADCAST', 'NONE')")
        return value
