...
class ServerTemplateDump(BaseModel):
    """
    ServerTemplateDump
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerTemplateDump:
        """Create an instance of ServerTemplateDump from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerTemplateDump:
        """Create an instance of ServerTemplateDump from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerTemplateDump.parse_obj(obj)

        _obj = ServerTemplateDump.parse_obj({
            "name": obj.get("name"),
            "type": obj.get("type"),
