...
class CreateResourceGroupData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateResourceGroupData:
        """Create an instance of CreateResourceGroupData from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateResourceGroupData:
        """Create an instance of CreateResourceGroupData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateResourceGroupData.parse_obj(obj)

        _obj = CreateResourceGroupData.parse_obj({
            "name": obj.get("name"),
