...
class ResourceGroupEssentialData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceGroupEssentialData:
        """Create an instance of ResourceGroupEssentialData from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceGroupEssentialData:
        """Create an instance of ResourceGroupEssentialData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceGroupEssentialData.parse_obj(obj)

        _obj = ResourceGroupEssentialData.parse_obj({
            "name": obj.get("name"),
