...
class SaveUserGroupData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SaveUserGroupData:
        """Create an instance of SaveUserGroupData from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SaveUserGroupData:
        """Create an instance of SaveUserGroupData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SaveUserGroupData.parse_obj(obj)
