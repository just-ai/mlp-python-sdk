...
class ModelCreateUpdateData(BaseModel):
    ...
    supported_servers: Optional[conlist(StrictStr)] = Field(default=None, alias="supportedServers")
    ...
    __properties = ["modelName", "imageAccountId", "imageId", "trainingModelAccountId", "trainingModelId", "trainingType", "trainingDatasetAccountId", "trainingDatasetId", "trainingFitConfigId", "taskType", "trainingDatasetType", "fitTemplateModelId", "composite", "prototype", "supportedServers", "rejectRequestsIfInactive", "config", "env", "additionalFlags", "fittable", "hostingType", "persistentVolumes", "dataImageMounts", "resourceGroup", "timeouts", "resourceLimits", "retriesConfig", "batchesConfig", "caching", "priorityQueue", "autoScalingConfiguration", "shortDescription", "languages", "minInstancesCount", "startTimeSec", "httpSettings", "archiveSettings", "aliases"]
    ...
    def from_dict(cls, obj: dict) -> ModelCreateUpdateData:
        ...
        _obj = ModelCreateUpdateData.parse_obj({
            ...
            "supported_servers": obj.get("supportedServers"),
