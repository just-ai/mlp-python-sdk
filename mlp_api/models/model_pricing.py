...
class ModelPricing(BaseModel):
    ...
    def vendor_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('AI21', 'ALIBABA', 'AMAZON', 'ANTHROPIC', 'BAAI', 'BAIDU', 'BYTEDANCE', 'COHERE', 'DEEPSEEK', 'FAL', 'GAMMA', 'GOOGLE', 'HEYGEN', 'INFLECTION', 'KLING', 'MANUS', 'META', 'MICROSOFT', 'MINIMAX', 'MISTRAL', 'MOONSHOT', 'NVIDIA', 'OPENAI', 'OPENROUTER', 'PARALLEL', 'PERPLEXITY', 'PIXVERSE', 'SBER', 'TENCENT', 'XAI', 'XIAOMI', 'YANDEX', 'ZHIPU', 'OTHER'):
            raise ValueError("must be one of enum values ('AI21', 'ALIBABA', 'AMAZON', 'ANTHROPIC', 'BAAI', 'BAIDU', 'BYTEDANCE', 'COHERE', 'DEEPSEEK', 'FAL', 'GAMMA', 'GOOGLE', 'HEYGEN', 'INFLECTION', 'KLING', 'MANUS', 'META', 'MICROSOFT', 'MINIMAX', 'MISTRAL', 'MOONSHOT', 'NVIDIA', 'OPENAI', 'OPENROUTER', 'PARALLEL', 'PERPLEXITY', 'PIXVERSE', 'SBER', 'TENCENT', 'XAI', 'XIAOMI', 'YANDEX', 'ZHIPU', 'OTHER')")
        return value
