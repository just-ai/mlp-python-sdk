...
class ModelPricing(BaseModel):
    ...
    def vendor_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('AI21', 'ALIBABA', 'AMAZON', 'ANTHROPIC', 'BAAI', 'BAIDU', 'BLACK_FOREST_LABS', 'BYTEDANCE', 'COHERE', 'DEEPSEEK', 'ELEVENLABS', 'FAL', 'GAMMA', 'GOOGLE', 'HEYGEN', 'IDEOGRAM', 'INFLECTION', 'INWORLD', 'KLING', 'KREA', 'LIGHTRICKS', 'MANUS', 'META', 'MICROSOFT', 'MINIMAX', 'MISTRAL', 'MOONSHOT', 'NVIDIA', 'OPENAI', 'OPENROUTER', 'PARALLEL', 'PERPLEXITY', 'PIXVERSE', 'RECRAFT', 'SBER', 'STABILITY_AI', 'TENCENT', 'XAI', 'XIAOMI', 'YANDEX', 'ZHIPU', 'OTHER'):
            raise ValueError("must be one of enum values ('AI21', 'ALIBABA', 'AMAZON', 'ANTHROPIC', 'BAAI', 'BAIDU', 'BLACK_FOREST_LABS', 'BYTEDANCE', 'COHERE', 'DEEPSEEK', 'ELEVENLABS', 'FAL', 'GAMMA', 'GOOGLE', 'HEYGEN', 'IDEOGRAM', 'INFLECTION', 'INWORLD', 'KLING', 'KREA', 'LIGHTRICKS', 'MANUS', 'META', 'MICROSOFT', 'MINIMAX', 'MISTRAL', 'MOONSHOT', 'NVIDIA', 'OPENAI', 'OPENROUTER', 'PARALLEL', 'PERPLEXITY', 'PIXVERSE', 'RECRAFT', 'SBER', 'STABILITY_AI', 'TENCENT', 'XAI', 'XIAOMI', 'YANDEX', 'ZHIPU', 'OTHER')")
        return value
