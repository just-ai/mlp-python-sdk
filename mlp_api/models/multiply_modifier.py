...
class MultiplyModifier(Modifier):
    ...
    __properties = ["when", "type", "multiplier", "appliesTo"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MultiplyModifier:
        """Create an instance of MultiplyModifier from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MultiplyModifier:
        """Create an instance of MultiplyModifier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MultiplyModifier.parse_obj(obj)

        _obj = MultiplyModifier.parse_obj({
