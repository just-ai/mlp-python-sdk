...
from mlp_api.apis.paths.api_mlpgate_account_account_dataset_c_b import ApiMlpgateAccountAccountDatasetCB
from mlp_api.apis.paths.api_mlpgate_account_account_dataset_c_a import ApiMlpgateAccountAccountDatasetCA
from mlp_api.apis.paths.api_mlpgate_account_account_dataset_b_b import ApiMlpgateAccountAccountDatasetBB
from mlp_api.apis.paths.api_mlpgate_account_account_dataset_b_a import ApiMlpgateAccountAccountDatasetBA
from mlp_api.apis.paths.api_mlpgate_account_account_dataset_a import ApiMlpgateAccountAccountDatasetA
...
PathToApi = typing_extensions.TypedDict(
    'PathToApi',
    {
        ...
        PathValues.API_MLPGATE_ACCOUNT_ACCOUNT_DATASET_C_B: ApiMlpgateAccountAccountDatasetCB,
        PathValues.API_MLPGATE_ACCOUNT_ACCOUNT_DATASET_C_A: ApiMlpgateAccountAccountDatasetCA,
        PathValues.API_MLPGATE_ACCOUNT_ACCOUNT_DATASET_B_B: ApiMlpgateAccountAccountDatasetBB,
        PathValues.API_MLPGATE_ACCOUNT_ACCOUNT_DATASET_B_A: ApiMlpgateAccountAccountDatasetBA,
        PathValues.API_MLPGATE_ACCOUNT_ACCOUNT_DATASET_A: ApiMlpgateAccountAccountDatasetA,
