...
import mlp_api.gpt.models
from mlp_api.gpt import rest
from mlp_api.gpt.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(mlp_api.gpt.models, klass)
