...
class Sort(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sorted", "empty", "unsorted", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sorted", "empty", "unsorted", ], str]):
