...
class PageModelInfoData(
        ...
        class properties:
            ...
            class content(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ModelInfoData']:
                        return ModelInfoData
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ModelInfoData'], typing.List['ModelInfoData']],
                ...
                def __getitem__(self, i: int) -> 'ModelInfoData':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["totalElements", "totalPages", "sort", "numberOfElements", "pageable", "last", "first", "size", "content", "number", "empty", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["totalElements", "totalPages", "sort", "numberOfElements", "pageable", "last", "first", "size", "content", "number", "empty", ], str]):
