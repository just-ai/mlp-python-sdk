...
class DeprecatedDatasetInfoWithContentData(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "description", "dataType", "content", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "description", "dataType", "content", ], str]):
