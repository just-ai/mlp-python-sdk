...
class ResourceGroupServersStatusData(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class statuses(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ServerStatusData']:
                        return ServerStatusData
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ServerStatusData'], typing.List['ServerStatusData']],
                ...
                def __getitem__(self, i: int) -> 'ServerStatusData':
    ...
    ) -> 'ResourceGroupServersStatusData':
        return super().__new__(
            cls,
            *_args,
            statuses=statuses,
