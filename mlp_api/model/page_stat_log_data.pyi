...
class PageStatLogData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["totalElements", "totalPages", "pageable", "first", "size", "content", "number", "sort", "last", "numberOfElements", "empty", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["totalElements", "totalPages", "pageable", "first", "size", "content", "number", "sort", "last", "numberOfElements", "empty", ], str]):
