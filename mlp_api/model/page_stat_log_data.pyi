...
class PageStatLogData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["totalElements", "totalPages", "first", "size", "content", "number", "sort", "numberOfElements", "last", "pageable", "empty", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["totalElements", "totalPages", "first", "size", "content", "number", "sort", "numberOfElements", "last", "pageable", "empty", ], str]):
