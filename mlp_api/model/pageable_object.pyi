...
class PageableObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["paged", "unpaged", "sort", "pageNumber", "pageSize", "offset", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["paged", "unpaged", "sort", "pageNumber", "pageSize", "offset", ], str]):
