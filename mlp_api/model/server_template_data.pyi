...
class ServerTemplateData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "type", "description", "rawConfiguration", "tarifficationPrice", "capacity", "tarifficationPeriod", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "type", "description", "rawConfiguration", "tarifficationPrice", "capacity", "tarifficationPeriod", ], str]):
