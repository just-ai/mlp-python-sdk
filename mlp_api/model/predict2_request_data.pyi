...
class Predict2RequestData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["data", "config", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["data", "config", ], str]):
