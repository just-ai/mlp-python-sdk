...
class PageableObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["offset", "sort", "pageSize", "pageNumber", "paged", "unpaged", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["offset", "sort", "pageSize", "pageNumber", "paged", "unpaged", ], str]):
