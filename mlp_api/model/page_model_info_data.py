...
class PageModelInfoData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["totalElements", "totalPages", "sort", "numberOfElements", "first", "last", "pageable", "size", "content", "number", "empty", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["totalElements", "totalPages", "sort", "numberOfElements", "first", "last", "pageable", "size", "content", "number", "empty", ], str]):
