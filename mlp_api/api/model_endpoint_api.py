...
class ModelEndpointApi:
    ...
    def create_cloned_model(self, account : Annotated[StrictStr, Field(..., description="Account id or account name")], model : Annotated[StrictStr, Field(..., description="Model id or model name")], name : StrictStr, display_name : Optional[StrictStr] = None, display_author : Optional[StrictStr] = None, auto_start : Optional[StrictBool] = None, template_id : Optional[StrictInt] = None, environment_variables : Optional[StrictStr] = None, mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, **kwargs) -> ModelInfoData:  # noqa: E501
        ...
        :type environment_variables: str
        :param mlp_api_key: token to use instead of a session
        :type mlp_api_key: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.create_cloned_model_with_http_info(account, model, name, display_name, display_author, auto_start, template_id, environment_variables, mlp_api_key, **kwargs)  # noqa: E501
    ...
    def create_cloned_model_with_http_info(self, account : Annotated[StrictStr, Field(..., description="Account id or account name")], model : Annotated[StrictStr, Field(..., description="Model id or model name")], name : StrictStr, display_name : Optional[StrictStr] = None, display_author : Optional[StrictStr] = None, auto_start : Optional[StrictBool] = None, template_id : Optional[StrictInt] = None, environment_variables : Optional[StrictStr] = None, mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.create_cloned_model_with_http_info(account, model, name, display_name, display_author, auto_start, template_id, environment_variables, mlp_api_key, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('environment_variables') is not None:  # noqa: E501
            _query_params.append(('environmentVariables', _params['environment_variables']))
    ...
    @validate_arguments
    def get_simple_doc_v2(self, account : Annotated[StrictStr, Field(..., description="Account id or account name")], model : Annotated[StrictStr, Field(..., description="Model id or model name")], mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, **kwargs) -> SimpleDocInfoData:  # noqa: E501
        """get_simple_doc_v2  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_simple_doc_v2(account, model, mlp_api_key, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: SimpleDocInfoData
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_simple_doc_v2_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_simple_doc_v2_with_http_info(account, model, mlp_api_key, **kwargs)  # noqa: E501

    @validate_arguments
    def get_simple_doc_v2_with_http_info(self, account : Annotated[StrictStr, Field(..., description="Account id or account name")], model : Annotated[StrictStr, Field(..., description="Model id or model name")], mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_simple_doc_v2  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_simple_doc_v2_with_http_info(account, model, mlp_api_key, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SimpleDocInfoData, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_simple_doc_v2" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "SimpleDocInfoData",
        }

        return self.api_client.call_api(
            '/api/mlpcore/account/{account}/model/{model}/simple-doc/v2', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
