...
class DatasetEndpointApi(object):
    ...
    def create_dataset(self, account : Annotated[StrictStr, Field(..., description="Account id or account name")], dataset_name : StrictStr, description : Optional[StrictStr] = None, data_type : Optional[StrictStr] = None, access_mode : Optional[StrictStr] = None, mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, file : Optional[Union[StrictBytes, StrictStr]] = None, **kwargs) -> DatasetInfoData:  # noqa: E501
        ...
        return self.create_dataset_with_http_info(account, dataset_name, description, data_type, access_mode, mlp_api_key, file, **kwargs)  # noqa: E501

    @validate_arguments
    def create_dataset_with_http_info(self, account : Annotated[StrictStr, Field(..., description="Account id or account name")], dataset_name : StrictStr, description : Optional[StrictStr] = None, data_type : Optional[StrictStr] = None, access_mode : Optional[StrictStr] = None, mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, file : Optional[Union[StrictBytes, StrictStr]] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """create_dataset  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_dataset_with_http_info(account, dataset_name, description, data_type, access_mode, mlp_api_key, file, async_req=True)
        >>> result = thread.get()
        ...
        _query_params = []
        if _params.get('dataset_name') is not None:  # noqa: E501
            _query_params.append(('datasetName', _params['dataset_name']))
