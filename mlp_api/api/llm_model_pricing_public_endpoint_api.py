...
class LlmModelPricingPublicEndpointApi:
    ...
    def get_all_pricing(self, mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, **kwargs) -> List[LlmModelPricingData]:  # noqa: E501
        ...
        >>> thread = api.get_all_pricing(mlp_api_key, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_all_pricing_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_all_pricing_with_http_info(mlp_api_key, **kwargs)  # noqa: E501

    @validate_arguments
    def get_all_pricing_with_http_info(self, mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_all_pricing  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_all_pricing_with_http_info(mlp_api_key, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_all_pricing" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
