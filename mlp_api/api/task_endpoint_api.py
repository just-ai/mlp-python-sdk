...
class TaskEndpointApi:
    ...
    @validate_arguments
    def mark_read(self, job_id : conlist(StrictStr), mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, **kwargs) -> None:  # noqa: E501
        """mark_read  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.mark_read(job_id, mlp_api_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the mark_read_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.mark_read_with_http_info(job_id, mlp_api_key, **kwargs)  # noqa: E501

    @validate_arguments
    def mark_read_with_http_info(self, job_id : conlist(StrictStr), mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """mark_read  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.mark_read_with_http_info(job_id, mlp_api_key, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('job_id') is not None:  # noqa: E501
            ...
            _collection_formats['jobId'] = 'multi'
    ...
    def short_jobs_view(self, mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, **kwargs) -> List[TaskShortData]:  # noqa: E501
        ...
        >>> thread = api.short_jobs_view(mlp_api_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the short_jobs_view_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.short_jobs_view_with_http_info(mlp_api_key, **kwargs)  # noqa: E501

    @validate_arguments
    def short_jobs_view_with_http_info(self, mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """short_jobs_view  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.short_jobs_view_with_http_info(mlp_api_key, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method short_jobs_view" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
