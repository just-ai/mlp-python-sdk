...
class MetricEndpointApi:
    ...
    @validate_arguments
    def get_token_spending_metric(self, account : Annotated[StrictStr, Field(..., description="Account id or account name")], token_id : StrictInt, time : Optional[StrictInt] = None, mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, **kwargs) -> List[TokenSpendingMetricData]:  # noqa: E501
        """get_token_spending_metric  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_token_spending_metric(account, token_id, time, mlp_api_key, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: List[TokenSpendingMetricData]
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_token_spending_metric_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_token_spending_metric_with_http_info(account, token_id, time, mlp_api_key, **kwargs)  # noqa: E501

    @validate_arguments
    def get_token_spending_metric_with_http_info(self, account : Annotated[StrictStr, Field(..., description="Account id or account name")], token_id : StrictInt, time : Optional[StrictInt] = None, mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_token_spending_metric  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_token_spending_metric_with_http_info(account, token_id, time, mlp_api_key, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[TokenSpendingMetricData], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_token_spending_metric" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "List[TokenSpendingMetricData]",
        }

        return self.api_client.call_api(
            '/api/mlpcore/account/{account}/token/{tokenId}/spending/metric', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_token_spending_metric_range(self, account : Annotated[StrictStr, Field(..., description="Account id or account name")], token_id : StrictInt, minutes : StrictInt, time : Optional[StrictInt] = None, step_seconds : Optional[StrictInt] = None, mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, **kwargs) -> List[TokenSpendingMetricRangeData]:  # noqa: E501
        """get_token_spending_metric_range  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_token_spending_metric_range(account, token_id, minutes, time, step_seconds, mlp_api_key, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: List[TokenSpendingMetricRangeData]
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_token_spending_metric_range_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_token_spending_metric_range_with_http_info(account, token_id, minutes, time, step_seconds, mlp_api_key, **kwargs)  # noqa: E501

    @validate_arguments
    def get_token_spending_metric_range_with_http_info(self, account : Annotated[StrictStr, Field(..., description="Account id or account name")], token_id : StrictInt, minutes : StrictInt, time : Optional[StrictInt] = None, step_seconds : Optional[StrictInt] = None, mlp_api_key : Annotated[Optional[StrictStr], Field(description="token to use instead of a session")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_token_spending_metric_range  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_token_spending_metric_range_with_http_info(account, token_id, minutes, time, step_seconds, mlp_api_key, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[TokenSpendingMetricRangeData], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_token_spending_metric_range" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "List[TokenSpendingMetricRangeData]",
        }

        return self.api_client.call_api(
            '/api/mlpcore/account/{account}/token/{tokenId}/spending/metric-range', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
