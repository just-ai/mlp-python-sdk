...
SchemaFor200ResponseBodyApplicationJson = InstanceEnvironmentData
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_model_instance_environment_oapg(
        self,
...
class GetModelInstanceEnvironment(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_model_instance_environment(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_model_instance_environment(
        ...
        return self._get_model_instance_environment_oapg(
