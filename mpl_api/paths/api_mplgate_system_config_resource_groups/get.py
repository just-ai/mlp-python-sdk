...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ResourceGroupData']:
            return ResourceGroupData

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ResourceGroupData'], typing.List['ResourceGroupData']],
    ...
    def __getitem__(self, i: int) -> 'ResourceGroupData':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_resource_groups_for_account_oapg(
        self,
...
class GetResourceGroupsForAccount(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_resource_groups_for_account(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_resource_groups_for_account(
        ...
        return self._get_resource_groups_for_account_oapg(
