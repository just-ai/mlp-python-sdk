...
# Query params
PreviousContainerSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'previousContainer': typing.Union[PreviousContainerSchema, bool, ],
    },
    total=False
)
...
request_query_previous_container = api_client.QueryParameter(
    name="previousContainer",
    style=api_client.ParameterStyle.FORM,
    schema=PreviousContainerSchema,
    explode=True,
)
# Header params
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_instance_log_file_oapg(
        self,
    ...
    def _get_instance_log_file_oapg(
        ...
        for parameter in (
            request_query_previous_container,
        ):
...
class GetInstanceLogFile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_instance_log_file(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def get_instance_log_file(
        ...
        return self._get_instance_log_file_oapg(
