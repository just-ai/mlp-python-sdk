...
# body param
SchemaForRequestBodyApplicationJson = PredictRequestData


request_body_predict_request_data = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _predict_with_config_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_predict_request_data.serialize(body, content_type)
...
class PredictWithConfig(BaseApi):
    ...
    def predict_with_config(
        ...
        return self._predict_with_config_oapg(
            body=body,
