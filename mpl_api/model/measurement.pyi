...
class Measurement(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ts", "v", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ts", "v", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        v: typing.Union[MetaOapg.properties.v, decimal.Decimal, int, float, ],
        ts: typing.Union[MetaOapg.properties.ts, decimal.Decimal, int, ],
