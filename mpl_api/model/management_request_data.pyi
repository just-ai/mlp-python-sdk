...
class ManagementRequestData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contacts", "comment", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contacts", "comment", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        contacts: typing.Union[MetaOapg.properties.contacts, str, ],
