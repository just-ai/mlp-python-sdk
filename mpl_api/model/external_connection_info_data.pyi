...
class ExternalConnectionInfoData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["model", "connectionToken", "activeConnections", "externalUrl", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["model", "connectionToken", "activeConnections", "externalUrl", ], str]):
